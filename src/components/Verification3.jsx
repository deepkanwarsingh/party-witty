...
import profile_verification_shield from '../assets/profile_verification_shield.png';
          ...
          <div className="relative w-48 h-48">
            ...
            <div className="w-full h-full rounded-full overflow-hidden  relative">
              <div className=" flex items-center justify-center">
                <img src={profile_verification_shield} alt="Verified" className="w-full h-full object-cover" />
              </div>
